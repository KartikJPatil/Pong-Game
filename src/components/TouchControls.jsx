...
export default function TouchControls({ 
  ...
  // FIXED: Only show ONE set of buttons based on player type
  if (!multiplayer || (multiplayer && player === "left")) {
    ...
    const currentTouchDir = touchDirL;

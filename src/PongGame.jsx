  ...
  return (
    <ConditionalOrientationGuard twoPlayer={twoPlayer && !multiplayer}>
      <div className="pong-container" style={{
        ...
        {/* FIXED: Play More Modal with proper z-index and close handling */}
        <Modal
        ...
        {/* FIXED: MultiplayerSection with corrected props */}
        <MultiplayerSection
        ...
        {/* FIXED: Single TouchControls - No duplicate controls */}
        <TouchControls
          player="left"
          boardRect={boardRect}
          twoPlayer={twoPlayer}
        ...
        {/* FIXED: GameControls with ready system */}
        <GameControls
          running={running}
          winner={winner}
          isPaused={isPaused}
